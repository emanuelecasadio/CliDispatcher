 ...
 * @since 0.8.4
 * */
public class DummySocketServer {

	static Logger cat = Logger.getLogger(DummySocketServer.class);
	...
	static void usage(String msg) {
		...
		System.err.println("Usage: java " + DummySocketServer.class.getName()
				+ " port configFile");
		System.exit(1);
	}
	...
	static void init(String portStr, String configFile) {
		...
		try {
			props.load(DummySocketServer.class.getResourceAsStream("/"+configFile));
